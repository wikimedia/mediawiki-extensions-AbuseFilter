...
class SpecialAbuseLog extends AbuseFilterSpecialPage {
	...
	public function showList() {
		...
		if ( $this->mSearchFilter ) {
			...
			// not be able to find log entries generated by it.
			if ( !$this->afPermissionManager->canViewProtectedVariables( $performer )->isGood() ) {
	...
	public function showDetails( $id ) {
		...
		$canViewProtectedVars = $this->afPermissionManager->canViewProtectedVariableValues( $userAuthority )->isGood();
