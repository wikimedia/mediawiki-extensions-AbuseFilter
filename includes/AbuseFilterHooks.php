...
class AbuseFilterHooks {
	...
	public static function filterEdit( IContextSource $context, Content $content, $text,
		...
		$vars = RunVariableGenerator::getEditVars(
			$title, $user, $content, $text, $summary, $slot, $page );
		if ( $vars === null ) {
	...
	public static function onTitleMove(
		...
		$vars = RunVariableGenerator::getMoveVars( $user, $oldTitle, $newTitle, $reason );
	...
	public static function onArticleDelete( WikiPage $article, User $user, $reason, &$error,
		Status $status ) {
		$vars = RunVariableGenerator::getDeleteVars( $user, $article, $reason );
	...
	public static function filterUpload( $action, UploadBase $upload, User $user,
		...
		$vars = RunVariableGenerator::getUploadVars(
			$action, $user, $title, $upload, $summary, $text, $props );
		if ( $vars === null ) {
			return true;
		}
		$runner = new AbuseFilterRunner( $user, $title, $vars, 'default' );
	...
	public static function onParserOutputStashForEdit(
		...
		DeferredUpdates::addCallableUpdate(
			function () use (
				...
				$startTime = microtime( true );
				$vars = RunVariableGenerator::newVariableHolderForEdit(
