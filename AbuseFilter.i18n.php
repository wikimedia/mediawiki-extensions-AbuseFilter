...
Pšosym pšos wužywarja z pšawom wobgranicowane akcije pśidaś, aby cynił změnu za tebje.',
	...
	'abusefilter-exception-unexpectedtoken' => 'Njewócakany token "$2" (typa $2) pla znamješka $1.',
...
:''(sin prefijo MediaWiki)''",
	...
	'abusefilter-history-backlist' => 'Regresar a lista de filtros',
...
:''(sans le préfixe MediaWiki)''",
	...
	'abusefilter-exception-unexpectedtoken' => 'Jeton « $3 » non-attendu (du type $2) au caractère $1.',
	...
	'abusefilter-exception-dividebyzero' => 'Essai illégal de diviser $2 par zéro au caractère $1.',
...
:''(ἰδιωτικόν)",
	...
	'abusefilter-test-load' => 'Ἐπιφορτίζειν',
...
[[Special:AbuseFilter|Povratak na glavni izbornik]].',
	...
	'abusefilter-reautoconfirm-none' => 'Ovom suradniku autoconfirmed status nije bio povučen.',
...
Kérj meg egy megfelelő jogosultságokkal rendelkező szerkesztőt, hogy végezze el számodra a változtatást.',
	...
	'abusefilter-history-backlist' => 'Vissza a szűrők listájához',
	...
	'abusefilter-exception-expectednotfound' => 'A(z) $1. karakternél $2 következett volna, azonban nem található.',
	'abusefilter-exception-unrecognisedkeyword' => 'Ismeretlen kulcsszó ($2) a(z) $1. karakternél.',
	'abusefilter-exception-unexpectedtoken' => 'Nem várt „$3” ($2 típusú) token a(z) $2. karakternél.',
...
:({{ns:8}} 접두어를 뺀 이름)',
	...
	'abusefilter-exception-expectednotfound' => '$1번째 문자에 있어야 할 $2가 발견되지 않았습니다.',
...
Сиидэ туһунан: $7 ($8) ($9)',
	...
	'abusefilter-tools-text' => 'Манна омсо сиидэлэрин туруорууларын уларытарга аналлаах үнүстүрүмүөннэр көстөллөр.
[[Special:AbuseFilter|Сүрүн талба сирэйгэ төннүү]]',
...
Бука диэн маны уларытар кыахтаах кыттааччыттан сиидэни эйиэхэ анаан уларытарыгар көрдөс.',
	...
	'abusefilter-edit-builder-misc-ternary' => 'Троичнай бэлиэ (1 ? 2 : 3)',
...
Xin hãy yêu cầu một thành viên có quyền thêm các tác vụ hạn chế để thực hiện thay đổi cho bạn.',
	...
	'abusefilter-exception-expectednotfound' => 'Cần một $2 ở ký tự $1, không tìm thấy.',
