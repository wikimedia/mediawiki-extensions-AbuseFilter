...
תיאור קצר של כלל ההשחתה אותו הפרה עריכתכם: $1',
	...
	'abusefilter-degroupreason' => 'הזכויות נשללו אוטומטית על ידי מסנן  ההשחתה. תיאור הכלל: $1',
	'abusefilter-accountreserved' => 'חשבון משתמש זה שמור לשימושו של מסנן ההשחתה.',
	'right-abusefilter-modify' => 'שינוי מסנני ההשחתה',
	'right-abusefilter-view' => 'עיון במסנני ההשחתה',
	'right-abusefilter-log' => 'עיון ביומן ההשחתה',
	'right-abusefilter-log-detail' => 'עיון ברשומות מפורטות ביומן ההשחתה',
	'right-abusefilter-private' => 'עיון בנתונים אישיים ביומן ההשחתה',
	'abusefilter-log' => 'יומן מסנן ההשחתה',
	'abusefilter-log-search' => 'חיפוש ביומן ההשחתה',
	'abusefilter-log-search-user' => 'משתמש:',
	'abusefilter-log-search-filter' => 'מזהה המסנן:',
	'abusefilter-log-search-title' => 'כותרת:',
	'abusefilter-log-search-submit' => 'חיפוש',
	'abusefilter-log-entry' => '$1: נגרמה הפעלת מסנן ההשחתה על ידי $2 , תבוצע הפעולה $3 על $4. פעולות שננקטו: $5; תיאור המסנן: $6',
	'abusefilter-log-detailedentry' => '$1: נגרמה הפעלת ה[[Special:AbuseFilter/$3|מסנן $3]] על ידי $2 , ובכך תבוצע הפעולה $4 על $5. הפעולות שננקטו: $6; תיאור המסנן: $7 ($8)',
	...
	'abusefilter-hitcount' => '{{PLURAL:$1|סינון $1|$1 סינונים}}',
	...
	'abusefilter-loglink' => 'עיון ביומן ההשחתה',
	...
	'abusefilter-tools-text' => 'הנה כמה כלים שעשויים להיות לכם לעזר בניסוח וניפוי השגיאות במסנני ההשחתה.
[[Special:AbuseFilter|חזרה לתפריט הראשי]]',
	'abusefilter-tools-expr' => 'בודק הביטויים',
	'abusefilter-tools-submitexpr' => 'הערכה',
	'abusefilter-tools-reautoconfirm' => 'שיחזור מצב האימות האוטומטי',
	'abusefilter-tools-reautoconfirm-user' => 'משתמש',
	'abusefilter-tools-reautoconfirm-submit' => 'אימות אוטומטי מחדש',
	'abusefilter-reautoconfirm-none' => 'למשתמש זה לא הושהה מצב האישור האוטומטי.',
	'abusefilter-reautoconfirm-notallowed' => 'אינכם מורשים לשחזר מצב אישור אוטומטי.',
	'abusefilter-status' => 'מתוך {{PLURAL:$1|הפעולה|$1 הפעולות}} האחרונות, $2 ($3%) {{PLURAL:$2|התאימה|התאימו}} לגבול התנאי $4. $5 ($6%) {{PLURAL:$5|תואם|תואמים}} לאחד מהמסננים הפעילים כעת.',
	'abusefilter-edit-subtitle' => 'עריכת המסנן $1',
	'abusefilter-edit-oldwarning' => '<strong>הנכם עורכים מהדורה ישנה של מסנן זה. הסטטיסטיקות המופיעות הינן עבור המהדורה העדכנית ביותר של המסנן. אם תשמרו את שינוייכם, אתם תשכתבו על כל השינויים  מאז המהדורה שהנכם עורכים.</strong> &bull; [[Special:AbuseFilter/history/$2|חזרה להיסטוריית מסנן זה]]',
	'abusefilter-edit-status-label' => 'סטטיסטיקות',
	'abusefilter-edit-status' => 'מ{{PLURAL:$1|הפעולה האחרונה|־$1 הפעולות האחרונות}}, מסנן זה תואם ל־$2 ($3%).',
...
:''(פרטי)",
	...
	'abusefilter-edit-hitcount' => 'סינונים:',
	'abusefilter-edit-consequences' => 'פעולות שננקטו בעת ההתאמה',
	'abusefilter-edit-action-warn' => 'פעולות אלה יבוצעו לאחר אזהרת המשתמש',
	'abusefilter-edit-action-disallow' => 'מניעת המשתמש מביצוע פעולות מפוקפקות',
	'abusefilter-edit-action-flag' => 'סמן את העריכה ביומן ההשחתה',
	'abusefilter-edit-action-blockautopromote' => 'שלול את מצב האישור האוטומטי של המשתמש',
	'abusefilter-edit-action-degroup' => 'הסר את המשתמש מכל הקבוצות הרשאיות',
	'abusefilter-edit-action-block' => 'חסום את המשתמש ו/או את כתובת ה־IP בפני עריכה',
	'abusefilter-edit-action-throttle' => 'ביצוע פעולות רק במידה והמשתמש מועד מספר פעמים',
	...
	'abusefilter-edit-throttle-seconds' => '{{PLURAL:$1|שניה $1|$1 שניות}}',
	'abusefilter-edit-warn-message' => 'הודעת המערכת לשימוש כאזהרה:',
	'abusefilter-edit-denied' => 'לא תוכלו לצפות בפרטים של מסנן זה, כיוון שהוא מוסתר מעיני הציבור',
	'abusefilter-edit-main' => 'הפרמטרים של המסנן',
	'abusefilter-edit-done-subtitle' => 'המסנן נערך',
	'abusefilter-edit-done' => 'שינוייכם למסנן נשמרו בהצלחה.

[[Special:AbuseFilter|חזרה]]',
	'abusefilter-edit-badsyntax' => 'ישנה שגיאת תחביר במסנן שציינתם. הפלט מהמפענח הינו: <pre>$1</pre>',
	'abusefilter-edit-viewhistory' => 'עיין בהיסטוריה של מסנן זה',
	'abusefilter-edit-history' => 'היסטוריה',
	'abusefilter-edit-check' => 'בדיקת תחביר',
	'abusefilter-edit-builder-select' => 'בחרו באפשרות להוספה לסמן',
	'abusefilter-edit-builder-group-op-arithmetic' => 'פעולות חשבוניות',
	...
	'abusefilter-edit-builder-group-op-comparison' => 'פעולות השוואה',
	'abusefilter-edit-builder-op-comparison-equal' => 'שווה ל־ (==)',
	'abusefilter-edit-builder-op-comparison-notequal' => 'לא שווה ל־ (!=)',
	'abusefilter-edit-builder-op-comparison-lt' => 'פחות מאשר (<)',
	'abusefilter-edit-builder-op-comparison-gt' => 'גדול מאשר (>)',
	'abusefilter-edit-builder-op-comparison-lte' => 'פחות מאשר או שווה ל־ (<=)',
	'abusefilter-edit-builder-op-comparison-gte' => 'גדול מאשר או שווה ל־ (>=)',
	'abusefilter-edit-builder-group-op-bool' => 'שערים לוגיים',
	...
	'abusefilter-edit-builder-misc-ternary' => 'פעולה שלישונית (1 ? 2 : 3)',
	'abusefilter-edit-builder-misc-in' => 'כלול במחרוזת (in)',
	'abusefilter-edit-builder-misc-like' => 'תואם לביטוי רגולרי (like)',
	...
	'abusefilter-edit-builder-funcs-lcase' => 'לאותיות קטנות (lcase)',
	'abusefilter-edit-builder-funcs-ccnorm' => 'נירמול אותיות מבלבלות (ccnorm)',
	...
	'abusefilter-edit-builder-vars-diff' => 'הפרש מאוחד של השינויים שבוצעו בעריכה',
	...
	'abusefilter-edit-builder-vars-summary' => 'עריכת תקציר/סיבה',
	'abusefilter-edit-builder-vars-article-id' => 'מזהה הערך',
	'abusefilter-edit-builder-vars-article-ns' => 'שם מרחב הערך',
	'abusefilter-edit-builder-vars-article-text' => 'כותרת הערך (ללא שם המרחב)',
	'abusefilter-edit-builder-vars-article-prefixedtext' => 'כותרת הערך המלאה',
	'abusefilter-edit-builder-vars-movedfrom-id' => 'מזהה הערך של דף המקור המועבר',
	'abusefilter-edit-builder-vars-movedfrom-ns' => 'שם המרחב של דף המקור המועבר',
	'abusefilter-edit-builder-vars-movedfrom-text' => 'כותרת דף המקור המועבר',
	'abusefilter-edit-builder-vars-movedfrom-prefixedtext' => 'הכותרת המלאה של דף המקור המועבר',
	'abusefilter-edit-builder-vars-movedto-id' => 'מזהה הערך של דף היעד להעברה',
	'abusefilter-edit-builder-vars-movedto-ns' => 'שם המרחב של דף היעד להעברה',
	'abusefilter-edit-builder-vars-movedto-text' => 'כותרת דף היעד להעברה',
	'abusefilter-edit-builder-vars-movedto-prefixedtext' => 'הכותרת המלאה של דף היעד להעברה',
	'abusefilter-edit-builder-vars-user-editcount' => 'מספר העריכות של משתמש',
	'abusefilter-edit-builder-vars-user-age' => 'גיל חשבון המשתמש',
	'abusefilter-edit-builder-vars-user-name' => 'שם חשבון המשתמש',
	'abusefilter-edit-builder-vars-user-groups' => 'קבוצות (כולל מרומזות) בהן נמצא המשתמש',
	'abusefilter-edit-builder-vars-user-emailconfirm' => 'התאריך בו אומתה כתובת הדוא"ל',
	'abusefilter-history' => 'ההיסטוריה עבור המסנן $1',
	...
	'abusefilter-history-flags' => 'דגלונים',
