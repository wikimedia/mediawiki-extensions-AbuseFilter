...
It reached the limit of matching more than $1% of actions.",
	...
	'abusefilter-edit-warn-preview' => 'Preview message',
...
من فضلك سل مستخدما ذا سماح إضافة الأفعال المحظورة ليفعل التغيير لك.',
	...
	'abusefilter-exception-expectednotfound' => 'لم يوجد $2 المتوقع عند الحرف $1.',
	'abusefilter-exception-unrecognisedkeyword' => 'كلمة مفتاحية غير متعرف عليها $2 عند الحرف $1.',
	'abusefilter-exception-unexpectedtoken' => 'نص غير متوقع "$2" عند الحرف $1.',
	...
	'abusefilter-exception-dividebyzero' => 'محاولة غير قانونية لقسمة $2 على صفر.',
...
السبب المعطى: $2',
	...
	'abusefilter-test-intro' => 'هذه الصفحة تسمح لك بالتحقق من فلتر مدخل في الصندوق بالأسفل ضد آخر $1 تغيير.
...
[[Special:AbuseFilter|Вярнуцца ў галоўнае мэню]].',
	...
	'abusefilter-reautoconfirm-none' => 'Гэты ўдзельнік ня мае адключанага статусу аўтаматычнага пацьверджаньня.',
...
[[Special:AbuseFilter/history/$2|Вярнуцца да гісторыі гэтага фільтру]].',
	...
	'abusefilter-edit-status' => '$2 ($3%) з $1 {{PLURAL:$1|апошняга дзеяньня|апошніх дзеяньняў|апошніх дзеяньняў}} адпавядае гэтаму фільтру.',
...
Калі ласка, зьвярніцеся да ўдзельніка з адпаведнымі правамі, каб дадаць абмежаванае дзеяньне.',
	...
	'abusefilter-edit-builder-misc-ternary' => 'Траісты апэратар (1 ? 2 : 3)',
	...
	'abusefilter-history' => 'Гісторыя фільтру $1',
	...
	'abusefilter-history-backlist' => 'Вярнуцца да сьпісу фільтраў',
	...
	'abusefilter-exception-unclosedstring' => 'Незачынены радок выразу, які пачынаецца са знаку $1.',
	'abusefilter-exception-invalidoperator' => 'Няслушны апэратар $2, знаку $1.',
	'abusefilter-exception-unrecognisedtoken' => 'Невядомы сымбаль «$2», знаку $1.',
	'abusefilter-exception-noparams' => 'Няма парамэтраў для функцыі «$2», знаку $1.',
	'abusefilter-exception-dividebyzero' => 'Спроба дзяленьня $2 на ноль.',
	'abusefilter-action-throttle' => 'Абмяжуй',
	'abusefilter-action-warn' => 'Папярэджаньне',
	'abusefilter-action-blockautopromote' => 'Заблякаваць аўтапрадвіжэньне',
	'abusefilter-action-block' => 'Блякіроўка',
	'abusefilter-action-degroup' => 'Выдаленьне з групы',
	'abusefilter-action-rangeblock' => 'Блякіроўка дыяпазону',
	'abusefilter-action-disallow' => 'Адхіліць',
...
Калі ласка, карыстайцеся гэтай прыладай асьцярожна.',
	'abusefilter-revert-preview-item' => '$1: $2 зрабіў $3 на $4.
Дзеяньні для адкату: $5 ($6)',
	'abusefilter-revert-search-legend' => 'Вызначце дзеяньні фільтра злоўжываньняў для адкату',
	'abusefilter-revert-periodstart' => 'Пачатак пэрыяду:',
	'abusefilter-revert-periodend' => 'Канчатак пэрыяду:',
...
Паданая прычына: $2',
	...
	'abusefilter-test' => 'Праверце фільтар на ўжо зробленых рэдагаваньнях',
	'abusefilter-test-intro' => 'Гэта старонка дазваляе Вам спраўдзіць фільтар паданы ў полі ніжэй на апошніх $1 зьменах.
Каб загрузіць існуючы фільтар, увядзіце яго ідэнтыфікацыйны код у поле, якое знаходзіцца ніжэй тэкставага поля і націсьніце кнопку «Загрузіць».',
	'abusefilter-test-legend' => 'Праверка фільтру',
	'abusefilter-test-load-filter' => 'Загрузіць фільтар з ідэнтыфікатарам:',
	'abusefilter-test-submit' => 'Праверка',
	...
	'abusefilter-changeslist-examine' => 'спраўдзіць',
	'abusefilter-examine' => 'Спраўдзіць адзінкавыя зьмены',
	'abusefilter-examine-intro' => 'Гэта старонка дазваляе Вам спраўдзіць пераменныя створаныя Фільтрам Злоўжываньняў для асобных зьменаў, і спраўдзіць іх на фільтрах.',
	'abusefilter-examine-legend' => 'Выбар зьменаў',
	'abusefilter-examine-diff' => 'URL розьніц вэрсій:',
	'abusefilter-examine-user' => 'Удзельнік:',
	'abusefilter-examine-title' => 'Назва старонкі:',
	'abusefilter-examine-submit' => 'Знайсьці',
	'abusefilter-examine-vars' => 'Пераменныя створаныя для гэтай зьмены',
	'abusefilter-examine-test' => 'Спраўдзіць гэту зьмену ў фільтры',
	'abusefilter-examine-test-button' => 'Спраўдзіць фільтар',
	'abusefilter-examine-match' => 'Фільтар распазнаў гэтую зьмену.',
	'abusefilter-examine-nomatch' => 'Фільтар не распазнаў гэтую зьмену.',
	'abusefilter-examine-syntaxerror' => 'У фільтры ёсьць сынтаксычная памылка',
	'abusefilter-examine-notfound' => 'Паданая Вамі зьмена ня можа быць знойдзена.',
	'abusefilter-examine-incompatible' => 'Паданая Вамі зьмена не падтрымліваецца Фільтрам Злоўжываньняў',
);
...
Navedeni razlog: $2',
	...
	'abusefilter-test-intro' => 'Ova stranica Vam omogućuje da provjerite filter koji je unesen u kutiju ispod protiv zadnjih $1 izmjena. Da napunite postojeći filter, unesite filter ID u kutiju ispod kutije za uređivanje i pritisnite dugme "Napuni".',
...
[[Special:AbuseFilter|Návrat do hlavního menu]].',
	...
	'abusefilter-reautoconfirm-none' => 'Tomuto uživateli nebyl příznak schváleného uživatele odebrán.',
...
Požádejte uživatele s oprávněním přidávat taková opatření, aby potřebnou změnu provedl za vás.',
	...
	'abusefilter-edit-builder-misc-ternary' => 'Ternární operátor (1 ? 2 : 3)',
	...
	'abusefilter-history' => 'Historie filtru $1',
	...
	'abusefilter-history-backlist' => 'Zpět na seznam filtrů',
...
Už existující filtr můžete použít tím, že jeho ID napíšete do rámečku pod editačním polem a kliknete na tlačítko „Načíst“.',
	...
	'abusefilter-examine' => 'Prozkoumat jednotlivé změny',
	'abusefilter-examine-intro' => 'Na této stránce budete moci u zvolené změny prozkoumat proměnné, které pro ni Filtr zneužívání vygeneroval, a otestovat na ní filtry.',
	'abusefilter-examine-legend' => 'Výběr změn',
...
Kurzbeschreibung der verletzten Regel: $1',
	...
	'right-abusefilter-log-detail' => 'Detailliertes Missbrauchsfilter-Logbuch einsehen',
...
$5 Aktionen ($6 %) {{PLURAL:$5|wurde|wurden}} von einem der aktivierten Filter erkannt.',
...
Bitte einen Benutzer, der verbotene Aktionen hinzufügen kann, darum, die Änderung für dich vorzunehmen.',
	...
	'abusefilter-edit-builder-vars-restrictions-edit' => 'Schutzstufe der Seite bearbeiten',
	'abusefilter-edit-builder-vars-restrictions-move' => 'Schutzstufe der Seite verschieben',
	...
	'abusefilter-exception-unexpectedatend' => 'Unerwartetes „$2“ am Zeichen „$1“.',
	'abusefilter-exception-expectednotfound' => 'Es wurde ein $2 bei Zeichen $1 erwartet, aber nicht gefunden.',
	'abusefilter-exception-unrecognisedkeyword' => 'Unbekanntes Schlüsselwort $2 bei Zeichen $1.',
	'abusefilter-exception-unexpectedtoken' => 'Unerwartetes Token „$2“ bei Zeichen $1.',
	...
	'abusefilter-exception-dividebyzero' => 'Division von $2 durch Null.',
...
Angegebener Grund: $2',
	...
	'abusefilter-test' => 'Einen Filter probeweise auf vorherige Bearbeitungen anwenden',
...
Wudaśe parsera jo było: <pre>$1</pre>',
	...
	'abusefilter-edit-builder-misc-ternary' => 'Ternarny operator (1 ? 2 : 4)',
	...
	'abusefilter-edit-builder-vars-summary' => 'Zapominanje(pśicyna wobźěłanja',
	...
	'abusefilter-history-backlist' => 'Slědk k filtrowej lisćinje',
	...
	'abusefilter-exception-expectednotfound' => 'Wócakowany $2 pla znamuška $1 njenamakany',
	...
	'abusefilter-exception-dividebyzero' => 'Njedowólony wopyt $2 pśez nul diwiděrowaś.',
...
$messages['es'] = array(
	...
	'abusefilter-log-details-ip' => 'Originando direcciín de IP',
	'abusefilter-log-noactions' => 'ninguna',
	'abusefilter-management' => 'Abuso de filtrar gestión',
	...
	'abusefilter-tools-text' => 'Hay algunas herramientas que pueden ser útiles formulando abuso de filtros.
[[Special:AbuseFilter|Regresar al menú principal]].',
...
:''(un par ligne, séparé par des virgules)''",
	...
	'abusefilter-edit-tag-tag' => 'Étiquette à appliquer (une par ligne) :',
	...
	'abusefilter-edit-test-link' => 'Tester ce filtre contre les éditions récentes',
	...
	'abusefilter-edit-builder-vars-restrictions-edit' => "Niveau de protection d'édition de la page",
	...
	'abusefilter-exception-unexpectedatend' => '« $2 » non-attendu au caractère $1.',
	...
	'abusefilter-test' => 'Tester un filtre avec les précédentes modifications',
	'abusefilter-test-intro' => 'Cette page vous permet de vérifier un filtre entré dans la boite ci-dessous avec les $1 dernières modifications. Pour charger un filtre existant, tapez son ID dans boite en dessous de la boite de texte et cliquez le bouton « Charger ».',
	'abusefilter-test-legend' => 'Test de filtre',
	'abusefilter-test-load-filter' => "Changer le filtre avec l'ID :",
	'abusefilter-test-submit' => 'Tester',
	'abusefilter-test-load' => 'Charger',
	'abusefilter-test-user' => "Modifications de l'utilisateur :",
	'abusefilter-test-period-start' => 'Changements faits après :',
	'abusefilter-test-period-end' => 'Changements faits avant :',
	'abusefilter-test-shownegative' => 'Afficher les modifications qui ne correspondent pas au filtre',
	'abusefilter-changeslist-examine' => 'examiner',
	'abusefilter-examine' => 'Examiner des modifications individuellement',
	'abusefilter-examine-intro' => "Cette page vous permet d'examiner les variables générées par le filtre des abus pour des modifications individuelles et les tester avec les filtres.",
	...
	'abusefilter-examine-match' => 'La modification a déclenché le filtre.',
	'abusefilter-examine-nomatch' => "La modification n'a pas déclenché le filtre.",
	'abusefilter-examine-syntaxerror' => 'Le filtre a une syntaxe invalide',
	'abusefilter-examine-notfound' => "La modification que vous avez demandé n'a pas été trouvée.",
	'abusefilter-examine-incompatible' => "La modification que vous avez demandé n'est pas compatible avec le filtre des abus.",
);
...
Por favor, pregúntelle a un usuario cos permisos necesarios para engadir accións restrinxidas se pode facer o cambio por vostede.',
	...
	'abusefilter-edit-builder-misc-rlike' => 'Coincide co regex (rlike)',
...
Motivo dado: $2',
	...
	'abusefilter-test-intro' => 'Esta páxina permítelle comprobar, cos últimos $1 cambios, un filtro inserido na caixa de embaixo.
...
:''(eini pro Zyyle, verbinde mit Kommata)''",
	...
	'abusefilter-edit-builder-misc-rlike' => 'Passt Regex aa (rlike)',
...
Grund: $2',
	...
	'abusefilter-test-intro' => 'Die Syte macht s megli Filter z priefe, wu unte im Chäschtli yygee isch gege di letschte $1 Änderige. Go nefilter z lade, wu s het, gib syyni Filter-ID in s Chäschtli unten yy un druck uf "Lade".',
	...
	'abusefilter-examine-intro' => 'Die Syte erlaubt Dir, d Variable, wu vum Missbruuchsfilter aagleit wore sin, uf individuälli Änmderige z iberpriefe un si nomol gege Filter z teschte.',
...
:''(一行に一つ、複数項目はコンマで区切る)''",
	...
	'abusefilter-exception-expectednotfound' => '$1文字目に $2 を予期しましたが、見つかりません。',
	'abusefilter-exception-unrecognisedkeyword' => '$1文字目に認識できないキーワード $2 があります。',
	'abusefilter-exception-unexpectedtoken' => '$1文字目に予期せぬトークン「$2」があります。',
...
Controleer de terug te draaien maatregelen zorgvuldig, en klik "Bevestigen" om uw selectie te bevestigen.',
	...
	'abusefilter-test-intro' => 'Op deze pagina kunt u een ingegeven filter controleren met de laatste $1 wijzingen.
...
:''(ein for kvar lina, kombiner med komma)''",
	...
	'abusefilter-exception-dividebyzero' => 'Ulovleg freistnad på å dela $2 på null.',
...
Sjå nøye gjennom dei, og trykk på «Stadfest» for å stadfesta valet ditt.',
	...
	'abusefilter-test-intro' => 'Denne sida lèt deg testa eit oppgjeve filter på dei siste $1 endringane.
...
Opis filtru: $7 ($8)',
	...
	'abusefilter-tools-text' => 'Oto kilka narzędzi, które mogą być przydatne w opracowywaniu i debugowaniu filtrów nadużyć. [[Special:AbuseFilter|Powrót do głównego menu]]',
...
:''(po jednej na linię, rozdzielone przecinkami)''",
	...
	'abusefilter-history' => 'Historia dla filtru $1',
	...
	'abusefilter-exception-expectednotfound' => 'Oczekiwano $2, znak nr $1.',
	'abusefilter-exception-unrecognisedkeyword' => 'Nierozpoznane słowo $2, znak nr $1.',
	'abusefilter-exception-unexpectedtoken' => 'Nieoczekiwany symbol „$2”, znak nr $1.',
...
Powód: $2',
	...
	'abusefilter-test-intro' => 'Ta strona pozwala na sprawdzenie wybranego w polu poniżej filtru na ostatnich $1 edycjach.
Aby załadować istniejący filtr, wprowadź jego ID do pola znajdującego się poniżej pola tekstowego i kliknij guzik „Załaduj”.',
	...
	'abusefilter-test-user' => 'Zmiany zrobione przez użytkownika:',
	...
	'abusefilter-examine-test' => 'Sprawdź tą zmianę przepuszczając ją poprzez filtr',
	'abusefilter-examine-test-button' => 'Testuj filtr',
	'abusefilter-examine-match' => 'Filtr rozpoznał tą zmianę.',
...
[[Special:AbuseFilter|Voltar ao menu principal]].',
...
:''(um por linha, combinar com vírgulas)''",
	...
	'abusefilter-test-intro' => 'Esta página permite-lhe verificar o filtro introduzido na caixa abaixo com as últimas $1 alterações.
...
Указанная причина: $2',
	...
	'abusefilter-test-intro' => 'Эта страница позволяет вам проверить фильтр, указанные в нижеприведённом поле, на последний $1 изменениях.
Чтобы загрузить существующий фильтр, введите его ИД и нажмите кнопку «Загрузить».',
	'abusefilter-test-legend' => 'Проверка фильтра',
	'abusefilter-test-load-filter' => 'Загрузить фильтр с ИД:',
	...
	'abusefilter-examine-match' => 'Это изменение подподает под фильтр.',
...
Uvedený dôvod: $2',
	...
	'abusefilter-test-intro' => 'Táto stránka vám umožňuje otestovať filter zadaný do poľa nižšie na posledých $1 úpravách. Existujúci filter načítate napísaním jeho ID do poľa pod poľom úprav a kliknuím na tlačidlo „Načítať“.',
...
:''(en per rad, kombinera med komman)''",
	...
	'abusefilter-test-intro' => 'Denna sida låter dig kolla upp ett filter inlagt i rutan nedan mot de senaste $1 ändringarna.
...
Eşleşen kuralın tanımı: $1',
	...
	'right-abusefilter-log-detail' => 'Ayrıntılı kötüye kullanım girdilerini gör',
	...
	'abusefilter-new' => 'Yeni süzgeç',
	'abusefilter-links' => 'Faydalı bağlantılar:',
	'abusefilter-tools-modifiertest-submit' => 'Test',
	'abusefilter-tools' => 'Kötüye kullanım süzgeçi araçları',
	'abusefilter-loglink' => 'Kötüye kullanım günlüğünü gör',
...
Miêu tả ngắn về quy luật lạm dụng mà tác vụ của bạn gặp phải là: $1',
	...
	'abusefilter-log-detailedentry' => '$1: $2 đã kích hoạt [[Special:AbuseFilter/$3|bộ lọc $3]], thực hiện tác động “$4” vào lúc $5. Tác vụ diễn ra: $6; Mô tả bộ lọc: $7 ($8)',
